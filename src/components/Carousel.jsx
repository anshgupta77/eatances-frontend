...
const Carousel = () => {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen px-4 lg:px-6 my-2 justify-between mx-auto w-[95%] lg:w-[90vw]">
      {/* Content Section */}
      ...
      {/* Image Section */}
      <div className="w-full lg:w-[40%] h-[50vh] lg:h-[100vh] flex flex-col justify-center mt-8 lg:mt-0">
