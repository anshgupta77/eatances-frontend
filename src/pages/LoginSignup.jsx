...
//       <div className="flex space border-b bg-white border-gray-300 py-3">
//         <Link to="/">
//           <div className="text-3xl font-bold text-blue-950 font-serif hover:text-[#228B22]" style={{ fontFamily: "'Poppins', sans-serif" }}>
//             eatances
//             <span className="text-[#0a830a] inline-flex align-baseline" style={{ fontSize: '1.5rem', marginLeft: '0.1rem' }}>
//               •
//             </span>
//           </div>
//         </Link>
...
//         <div className="w-full max-w-[350px] my-4">
//           <div className="border border-gray-300 rounded-lg p-6 bg-white">
//             <h1 className="text-3xl font-normal mb-4">{isLoginView ? 'Sign-In' : 'Create account'}</h1>
//             {error && (
//               <div className="mb-4 p-3 bg-red-100 border border-red-400 text-red-700 text-sm rounded">
//                 {error}
//               </div>
...
//                   <input type="text" name="name" value={formData.name} onChange={handleInputChange} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-yellow-600 focus:ring-1 focus:ring-yellow-600 focus:outline-none" placeholder="First and last name" />
//                 </div>
//               )}

//               <div className="mb-4">
//                 <label className="block text-sm font-bold mb-1">Email</label>
//                 <input type="email" name="email" value={formData.email} onChange={handleInputChange} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-yellow-600 focus:ring-1 focus:ring-yellow-600 focus:outline-none" />
//               </div>
...
//                 <div className="mb-4">
//                   <label className="block text-sm font-bold mb-1">Role</label>
//                   <select name="role" value={formData.role} onChange={handleInputChange} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-yellow-600 focus:ring-1 focus:ring-yellow-600 focus:outline-none">
//                     <option value="">Select Role</option>
//                     <option value="admin">Admin</option>
//                     <option value="customer">Customer</option>
//                     <option value="merchant">Merchant</option>
...
//               <button type="submit" className="w-full text-white bg-[#228B22] hover:text-blue-950 border border-green-500 rounded-lg py-1 px-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 mt-2">
//                 {isLoginView ? 'Sign-In' : 'Create your Eatance account'}
//               </button>
